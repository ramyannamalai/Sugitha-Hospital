...
import logo from "../assets/images/logo.jpg"; // ✅ Updated file name to match "sugitha"
  ...
  <footer className="bg-teal-700 py-12 text-white">
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-10 px-6">
      ...
      <div className="max-w-xs">
        <img src={logo} alt="Dr. Sugitha Hospital Logo" className="w-32 h-32" />
        <p className="text-white/90 mt-2 text-justify">
          At Dr. Sugitha Hospital, we are dedicated to providing compassionate, high-quality healthcare for individuals and families.
        </p>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-3">
          <li className="flex items-center gap-2">
            ...
            <span>
              <a href="tel:7449034505" className="hover:text-teal-300">7449034505</a> /
              <a href="tel:04446029809" className="hover:text-teal-300 ml-1">044 46029809</a>
            </span>
          </li>
          <li className="flex items-center gap-2">
            <span className="text-lg">✉️</span>
            <span>
              <a href="mailto:dr.sugithahospital@gmail.com" className="hover:text-teal-300">
                dr.sugithahospital@gmail.com
              </a>
            </span>
          </li>
          <li className="flex items-center gap-2">
            <span className="text-lg">📍</span>
            <span>
              Plot no.14a, Radha Avenue Main<br />
              Road, Sridevi Kuppam, Valasaravakkam,<br />
              Chennai-600087
            </span>
          </li>
